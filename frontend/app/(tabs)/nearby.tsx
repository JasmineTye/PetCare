...
const Nearby = () => {
  ...
  const fetchNearbyPetCare = async (latitude: number, longitude: number) => {
    try {
      const response = await axios.get(
        "http://192.168.0.167:8080/api/googlemaps/getNearbyByTypes",
        {
          params: {
            latitude,
            longitude,
  ...
  const applySearch = async () => {
    ...
    try {
      const response = await axios.get(
        `http://192.168.0.167:8080/api/googlemaps/searchLocationByKeyword`,
        {
          params: {
            latitude,
            longitude,
  ...
  const applyFilters = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `http://192.168.0.167:8080/api/googlemaps/filterLocations`,
        {
          params: {
